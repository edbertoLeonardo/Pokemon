...
import br.com.leonardo.myapplication.adapter.PokemonListAdapter;
import br.com.leonardo.myapplication.common.Common;
import br.com.leonardo.myapplication.common.ItemOffsetDecoration;
import br.com.leonardo.myapplication.model.Pokedex;
import br.com.leonardo.myapplication.retrofit.IPokedex;
import br.com.leonardo.myapplication.retrofit.RetrofitClient;
...
public class PokemonList extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pokemonListRecyclerView = view.findViewById(R.id.pokemonListRecyclerView);
        pokemonListRecyclerView.setHasFixedSize(true);
        pokemonListRecyclerView.setLayoutManager(new GridLayoutManager(getActivity(), 2));
        ItemOffsetDecoration itemOffsetDecoration = new ItemOffsetDecoration(getActivity(), R.dimen.spacing);
        pokemonListRecyclerView.addItemDecoration(itemOffsetDecoration);
    ...
    private void fetchData() {
        ...
        .subscribe(new Consumer<Pokedex>() {
            ...
            public void accept(Pokedex pokedex) throws Exception {
                Common.commonPokemonist = pokedex.getPokemon();
                PokemonListAdapter adapter = new PokemonListAdapter(getActivity(), Common.commonPokemonist);
